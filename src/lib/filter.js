...
module.exports = {
    ...
    filterProject: (project, task) => {
        // check if the input exists in the project store
        if (task.getProjects[project]) {
            return errorMessage.projectExists;
        }
        // return an error message if the input is in the project store
        // Otherwise add the project to the store
    }
}